...
function onAddProduct(e){
    ...
    axios.post("https://crudcrud.com/api/4b881f5cbe114018abff7405e00f042a/productDetails",obj)
    .then((res)=>{
        console.log(res)
...
window.addEventListener("DOMContentLoaded",()=>{
    axios.get("https://crudcrud.com/api/4b881f5cbe114018abff7405e00f042a/productDetails")
    .then(res=>{
        console.log(res);
...
function showUserOnScreen(objects){
  ...
  delbtn.onclick=()=>{
    ...
    axios.delete(`https://crudcrud.com/api/4b881f5cbe114018abff7405e00f042a/productDetails/${objects._id}`)
